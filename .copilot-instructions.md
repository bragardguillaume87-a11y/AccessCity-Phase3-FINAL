...
- [ ] `data/ui_layout.json` - **ENRICHIR** : 4 layouts (standard, focus, accessibility, devtools)

### UI Components
- [x] SceneList.js - Liste scenes avec selection
- [x] InspectorPanel.js - Editeur CRUD scenes/dialogues
- [ ] DevToolsPanel.js - **ACTIVER** (actuellement cache)
- [ ] CharacterEditor.js - Edition personnages avec upload sprites

### Tests Unitaires
- [ ] `test/core.variableManager.test.js` **A CREER**
- [ ] `test/core.conditionEvaluator.test.js` **A CREER**
- [ ] `test/core.characterLoader.test.js` **A CREER**

### Criteres Validation Phase 5.5
- [ ] Variables narratives fonctionnelles (Empathie, Autonomie, Confiance)
- [ ] Personnages definis avec sprites et moods
- [ ] Conditions evaluees pour filtrer dialogues
- [ ] DevToolsPanel affiche variables temps reel
- [ ] InspectorPanel dropdown personnages fonctionnel
- [ ] 4 layouts UI disponibles et switchables
