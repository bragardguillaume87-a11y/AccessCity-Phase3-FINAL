...
8	Properties panel mal intégré	Scroll, perte de contexte, zone flottante	Zone non annoncée, rôle ARIA manquant	🟡 Important
3. MÉTHODOLOGIE : CONSEIL DES IA
...
└─ Tâche 8: Undo/Redo toolbar (36/50)
...
Les 8 Tâches Prioritaires (Spécifications complètes)
...
7. PHASE 1A : FONDATIONS (4 tâches critiques)
...
:root {
  ...
  /* Backgrounds - Dark theme (WCAG AA compliant) */
  --color-bg-base: #0F172A;           /* Slate 900 - Base canvas */
  --color-bg-elevated: #1E293B;       /* Slate 800 - Cards, panels */
  --color-bg-hover: #334155;          /* Slate 700 - Hover states */
  --color-bg-active: #475569;         /* Slate 600 - Active/selected */
  --color-bg-overlay: rgba(15, 23, 42, 0.95);  /* Modals backdrop */
  
  /* Text - Contrast ratios WCAG AA on dark bg */
  --color-text-primary: #F1F5F9;      /* Slate 100 - 14:1 ratio ✓ */
  --color-text-secondary: #CBD5E1;    /* Slate 300 - 7:1 ratio ✓ */
  --color-text-muted: #94A3B8;        /* Slate 400 - 4.5:1 ratio ✓ */
  --color-text-disabled: #64748B;     /* Slate 500 - 3:1 ratio */
...
css
/* src/components/layout/EditorShell.css */
.editor-shell {
  display: flex;
...
@media (max-width: 1024px) {
  ...
  /* Inspector devient un panneau overlay */
  .inspector {
    position: fixed;
    right: 0;
    top: 60px;
...
css
/* src/components/features/DialogueGraph.css */
