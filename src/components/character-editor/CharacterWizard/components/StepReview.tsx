...
import { Star, CheckCircle2, AlertCircle, ChevronLeft, ChevronRight, Sparkles, Edit2 } from 'lucide-react';
...
function SummaryCard({ title, icon, value, isComplete, onEdit }: SummaryCardProps) {
  return (
    <button
      type="button"
      onClick={onEdit}
