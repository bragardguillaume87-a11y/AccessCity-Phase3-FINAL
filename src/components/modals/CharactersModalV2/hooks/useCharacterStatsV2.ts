...
/**
 * Return type for useCharacterStatsV2 hook
 */
...
/**
 * useCharacterStatsV2 - Memoized character statistics calculation
 *
 ...
 * ## Usage
 * ```tsx
 * const { getCharacterStats, totalStats, statsMap } = useCharacterStatsV2(characters);
 *
 ...
 */
export function useCharacterStatsV2(characters: Character[]): UseCharacterStatsV2Return {
...
export default useCharacterStatsV2;
