...
export default function ExportModal({ onClose }: ExportModalProps) {
  ...
  const handleExport = useCallback(async () => {
    ...
    try {
      const scenesToExport: Scene[] = scope === 'scene' && activeScene ? [activeScene] : allScenes;
      ...
      setStepIndex(0);
      const exportData = buildExportData(scenesToExport, characters, projectSettings, {
        ...
        >
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="font-bold text-base text-white leading-tight">Exporter le scénario</h2>
            ...
            <div className="grid grid-cols-2 gap-2.5">
              ...
              >
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{
                      color:
                        scope === 'all' ? 'rgba(255,255,255,0.6)' : 'hsl(var(--muted-foreground))',
                    }}
                  >
              ...
              <button
                ...
                style={{
                  ...
                  background:
                    scope === 'scene'
                      ? 'linear-gradient(135deg, rgba(168,85,247,0.15), var(--color-primary-08))'
                      : hasActiveScene
                        ? 'hsl(var(--muted)/40%)'
                        : 'hsl(var(--muted)/20%)',
              ...
              >
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{
                      color:
                        format === 'zip' ? 'rgba(255,255,255,0.6)' : 'hsl(var(--muted-foreground))',
                    }}
                  >
                    Navigateur — tous OS
                  </p>
              ...
              >
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{
                      color:
                        format === 'exe' ? 'rgba(255,255,255,0.6)' : 'hsl(var(--muted-foreground))',
                    }}
                  >
                    Windows 10/11
                  </p>
          ...
          {format === 'zip' ? (
            ...
            >
              ...
              >
                ...
                <strong className="text-white/70 font-medium">index.html</strong> jouable dans un
                navigateur.
              </p>
            </div>
          ) : (
            ...
            >
              ...
              >
                ...
                <strong className="text-white/70 font-medium">Windows 10/11</strong> requis
                (Edge/WebView2).
              </p>
            </div>
          )}
