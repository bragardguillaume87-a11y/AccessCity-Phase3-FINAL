 ...
 *
 * @param {Object} props
 * @param {Function} props.onResetDefaults - Callback to reset settings to defaults
 * @param {Function} props.onExport - Callback to export settings
 * @param {Function} props.onImport - Callback to handle import file selection
 */
export function SettingsHeader({ onResetDefaults, onExport, onImport }) {
  return (
