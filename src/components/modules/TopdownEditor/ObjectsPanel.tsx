...
import { Plus, Settings, Crown, Search, Upload, ChevronDown, X, MapPin } from 'lucide-react';
...
import { AnimThumb } from './ObjectsPanel/components/AnimThumb';
import { SpritePicker } from './ObjectsPanel/components/SpritePicker';
