...
DialogueFlowVisualization.propTypes = {
  selectedScene: PropTypes.object.isRequired,
  selectedElement: PropTypes.object,
  viewMode: PropTypes.oneOf(['visual', 'graph']).isRequired,
  onViewModeChange: PropTypes.func.isRequired,
  onDialogueClick: PropTypes.func.isRequired,
