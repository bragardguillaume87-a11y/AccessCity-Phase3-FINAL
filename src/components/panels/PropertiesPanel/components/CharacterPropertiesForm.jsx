 ...
 *
 * @param {Object} props
 * @param {Object} props.character - Character object to edit
 * @param {Array} props.characters - All characters (for mood management)
 * @param {Object} props.selectedElement - Selected element info
 * @param {Object} props.scenes - All scenes (for statistics)
 * @param {Function} props.onUpdate - Callback to update character
 * @param {Function} props.onDuplicate - Callback to duplicate character
...
CharacterPropertiesForm.propTypes = {
