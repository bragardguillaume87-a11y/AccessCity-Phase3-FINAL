        ...
        <div className="px-3 py-2.5">
          <select
            ...
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) =>
              onUpdate({ speaker: e.target.value })
            }
                    ...
                    .map((profile) => {
                      ...
                      return (
                        <motion.button
                          ...
                          type="button"
                          onClick={() =>
                            onUpdate({ voicePreset: isActive ? undefined : profile.id })
                          }
          ...
          <InlineAccordion isOpen={moodsOpen}>
            <div className="px-3 py-3 space-y-3">
              {scene.characters.map((sceneChar) => {
                ...
                const availableMoods: string[] = character.moods?.length
                  ? character.moods
                  : ['neutral'];
                    ...
                    >
                      <motion.button
                        ...
                        style={{
                          ...
                          background: !overrideMood ? 'var(--color-primary-15)' : 'transparent',
                          color: !overrideMood ? 'var(--color-primary)' : 'var(--color-text-muted)',
                          fontSize: '9.5px',
                          fontWeight: 700,
                          cursor: 'pointer',
                          boxShadow: !overrideMood ? '0 3px 10px var(--color-primary-30)' : 'none',
                        }}
                      >
                        ✦ Défaut
                      </motion.button>
