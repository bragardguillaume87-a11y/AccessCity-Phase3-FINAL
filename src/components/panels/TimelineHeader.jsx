 ...
 *
 * @param {Object} props
 * @param {Array} props.scenes - Array de scènes [{id, title, description, dialogues}]
 * @param {string} props.selectedSceneId - ID de la scène actuellement sélectionnée
 * @param {Function} props.onSceneSelect - Callback (sceneId) quand une scène est cliquée
 * @param {Function} props.onAddScene - Callback pour créer une nouvelle scène
 */
