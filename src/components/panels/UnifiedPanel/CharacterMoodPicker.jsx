 ...
 *
 * @param {Object} props
 * @param {Function} props.onDragStart - Callback (characterId, mood) on drag start
 */
export default function CharacterMoodPicker({ onDragStart }) {
  const characters = useCharactersStore(state => state.characters);
  const [hoveredCharacterId, setHoveredCharacterId] = useState(null);

  const handleDragStart = (e, characterId, mood) => {
        ...
        return (
          ...
          >
            ...
            <motion.div
              ...
              draggable
              onDragStart={(e) => handleDragStart(e, character.id, defaultMood)}
                ...
                >
                  ...
                  {moods.map((mood) => (
                    <motion.button
                      key={mood}
                      draggable
                      onDragStart={(e) => handleDragStart(e, character.id, mood)}
