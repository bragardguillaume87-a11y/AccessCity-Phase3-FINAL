...
const SHADOW_BASE   = '0 1px 3px rgba(0,0,0,0.8), 0 8px 20px rgba(0,0,0,0.55), inset 0 1px 0 rgba(255,255,255,0.05)';
...
export const defaultTheme: GraphTheme = {
  ...
  nodes: {
    ...
    dialogue: {
      ...
      text:              '#e2e8f0',
      shadow:            SHADOW_BASE,
      shadowHover:       '0 1px 3px rgba(0,0,0,0.8), 0 12px 30px rgba(0,0,0,0.65), inset 0 1px 0 rgba(255,255,255,0.07)',
      shadowSelected:    '0 0 0 1px rgba(59,130,246,0.7), 0 0 22px rgba(59,130,246,0.28), 0 8px 20px rgba(0,0,0,0.65), inset 0 1px 0 rgba(255,255,255,0.07)',
    },
    ...
    choice: {
      ...
      shadow:            SHADOW_BASE,
      shadowHover:       '0 1px 3px rgba(0,0,0,0.8), 0 12px 30px rgba(0,0,0,0.65), inset 0 1px 0 rgba(255,255,255,0.07)',
      shadowSelected:    '0 0 0 1px rgba(139,92,246,0.7), 0 0 22px rgba(139,92,246,0.28), 0 8px 20px rgba(0,0,0,0.65), inset 0 1px 0 rgba(255,255,255,0.07)',
    },
    ...
    terminal: {
      ...
      text:              '#94a3b8',
      shadow:            SHADOW_BASE,
      shadowHover:       '0 1px 3px rgba(0,0,0,0.8), 0 12px 30px rgba(0,0,0,0.65), inset 0 1px 0 rgba(255,255,255,0.05)',
      shadowSelected:    '0 0 0 1px rgba(100,116,139,0.7), 0 0 18px rgba(100,116,139,0.2), 0 8px 20px rgba(0,0,0,0.65), inset 0 1px 0 rgba(255,255,255,0.05)',
    },
    ...
    response: {
      ...
      text:              '#6ee7b7',
      shadow:            SHADOW_BASE,
      shadowHover:       '0 1px 3px rgba(0,0,0,0.8), 0 12px 30px rgba(0,0,0,0.65), inset 0 1px 0 rgba(255,255,255,0.06)',
      shadowSelected:    '0 0 0 1px rgba(16,185,129,0.7), 0 0 22px rgba(16,185,129,0.28), 0 8px 20px rgba(0,0,0,0.65), inset 0 1px 0 rgba(255,255,255,0.06)',
    },
  },
