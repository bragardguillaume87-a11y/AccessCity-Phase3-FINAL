...
/**
 * Scan dialogues for incomplete or empty elements.
 *
 * Checks:
 ...
 *
 * Pure function — no React dependency. Wrap with useMemo in hooks.
 */
export function checkDialogueIntegrity(dialogues: Dialogue[]): IntegrityIssue[] {
