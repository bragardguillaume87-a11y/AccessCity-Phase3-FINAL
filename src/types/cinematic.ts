...
export type CinematicSpeed = 'instant' | 'fast' | 'normal' | 'slow';
...
export const CINEMATIC_EVENT_META: CinematicEventMeta[] = [
  ...
  { type: 'sfx',             label: 'Son',                emoji: '🔊', group: 'audio' },
  // Effects
  { type: 'screenShake',     label: 'Tremblement',        emoji: '📳', group: 'effects' },
  { type: 'flash',           label: 'Flash',              emoji: '⚡', group: 'effects' },
  // V2
  { type: 'vignette',        label: 'Halo sombre',        emoji: '🔲', group: 'effects', v2: true },
  ...
  { type: 'titleCard',       label: 'Carte titre',        emoji: '📋', group: 'essential', v2: true },
  { type: 'characterShake',  label: 'Personnage surpris', emoji: '😱', group: 'characters', v2: true },
  { type: 'bgm',             label: 'Changer la musique', emoji: '🎵', group: 'audio', v2: true },
];
