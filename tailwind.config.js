  ...
  theme: {
    extend: {
      colors: {
        ...
        // App Native palette (GDevelop-inspired)
        'app-bg': '#f8fafc',
        'panel-bg': '#ffffff',
        'panel-bg-alt': '#f1f5f9',
        'border': '#e2e8f0',
        ...
        warning: '#f59e0b',
        error: '#ef4444',
        // Game-like palette (vibrant & energetic)
        'game-purple': '#8B5CF6',
      ...
      keyframes: {
        ...
        glowPulse: {
          '0%, 100%': { boxShadow: '0 0 20px var(--glow-color, rgba(139, 92, 246, 0.3))' },
          '50%': { boxShadow: '0 0 40px var(--glow-color, rgba(139, 92, 246, 0.6))' },
        },
        shimmer: {
